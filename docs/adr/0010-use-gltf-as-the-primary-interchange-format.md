...
Version 0.1 will not contain a restricted loader. Correct static glTF/GLB
loading is instead the first major post-0.1 feature block and arrives with the
minimum lighting and metallic-roughness PBR behavior required to represent
ordinary assets honestly. Animation, skinning, morph targets, stored lights,
and compression extensions follow only with matching runtime capabilities and
focused examples.
