...
public final class FirstPersonSandboxExample {
     ...
     *
     * <p>Click the rendered view to capture the pointer, use W A S D or the arrow keys to move,
     * Space to jump, and Escape to release the pointer.
     *
    ...
    private static final class SandboxApplication implements GameApplication {
        ...
        private void updatePointerLook() {
