 ...
 */
package io.github.glynch.jscene3d.game.examples.tools;

import io.github.glynch.jscene3d.examples.framework.ThumbnailCaptureSupport;
import io.github.glynch.jscene3d.game.examples.ExampleCatalog;
import java.nio.file.Path;
import java.util.List;

/** Refreshes captured thumbnails for the game-runtime example suite. */
public final class ExampleThumbnailCapture {
    ...
    private static final Path DEFAULT_DIRECTORY =
            Path.of("src", "main", "resources", "META-INF", "jscene3d", "game-examples", "thumbnails");
