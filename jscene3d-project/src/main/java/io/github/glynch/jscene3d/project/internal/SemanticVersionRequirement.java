...
public final class SemanticVersionRequirement {
    private final List<Clause> clauses;

    /** Stores a validated sequence of version comparisons. */
    private SemanticVersionRequirement(List<Clause> clauses) {
     ...
     *
     * @param expression version-requirement expression
     * @return parsed requirement, or empty when invalid
     */
    public static Optional<SemanticVersionRequirement> parse(String expression) {
        ...
        return Optional.of(new SemanticVersionRequirement(List.copyOf(clauses)));
    }

    /**
     * Returns whether every comparison accepts the candidate.
     *
     * @param candidate semantic version to test
     * @return {@code true} when every comparison accepts the version
     */
    public boolean includes(SemanticVersion candidate) {
